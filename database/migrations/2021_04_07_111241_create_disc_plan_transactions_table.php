...
class CreateDiscPlanTransactionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('disc_plan_transactions', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('disc_plan_transactions');
    }
}
